...
DECLARE_SYMBOL_CLASS_3(Body, body, constant_decl_opt, type_decl_opt, block)
DECLARE_SYMBOL_CLASS_3(Block, block, constant_decl_opt, type_decl_opt, block)
...
DECLARE_SYMBOL_CLASS_0_3(LvaluePrefixedList, lvalue_prefixed_list, Empty, Cons, empty, cons, lvalue_prefixed_list, comman_operator0, lvalue)
...
public:
	...
	DECLARE_SYMBOL_FIELDS_3(Body, body, constant_decl_opt, type_decl_opt, block)
	DECLARE_SYMBOL_FIELDS_3(Block, block, constant_decl_opt, type_decl_opt, block)
	...
	DECLARE_SYMBOL_FIELDS_0_3(LvaluePrefixedList, lvalue_prefixed_list, Empty, Cons, empty, cons, lvalue_prefixed_list, comman_operator0, lvalue)
